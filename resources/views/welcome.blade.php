...
<div id="rev_arrows" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
   <ul> <!-- SLIDE  -->
      ...
      <!-- MAIN IMAGE -->
      <img src="b{{asset('images/arrow-slide1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
         ...
         <div id="services-slider" class="owl-carousel">
            <div class="item">
               <div class="service-box">
                  ...
                  <h4 class="bottom10"><a href="javascript:void(0)">Documents à Télècharger</a></h4>
            ...
            <div class="item">
               <div class="service-box">
                  ...
                  <h4 class="bottom10"><a href="javascript:void(0)">Devenir Formateur</a></h4>
                     <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet</p>
               </div>        
            </div>
            <div class="item">
      ...
      <div class="row">
         ...
         <div class="col-md-7 col-sm-12">
            <div class="split-box center-block equalheight container-padding">
               ...
               <h2 class="darkcolor bottom25 wow fadeIn" data-wow-delay="350ms">Découvrir notre Centre</h2>
               ...
               <a href="#" class="button btnsecondary wow fadeInUp" data-wow-delay="450ms">Lire Plus</a>
            </div>
    ...
    <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               <span>DERNIERS ÉVÈNEMENTS</span>
               <h3 class="darkcolor bottom10">Differents Cours à Télècharger</h3>
      ...
      <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               ...
               <h2 class="darkcolor bottom20">Rencontrez nos Formateurs</h2>
               <p class="heading_space">Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae diam eleifend, in maximus metus sollicitudin. Quisque vitae sodales lectus. Nam porttitor justo sed mi finibus, vel tristique risus faucibus. </p>
            </div>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-7 col-sm-7 wow fadeInLeft" data-wow-delay="300ms">
            <div class="heading-title text-md-left text-center padding_bottom">
               ...
               <a href="#contactus" class="button btnprimary top20 pagescroll">Contactez Nous</a>
            </div>
         </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
           <div class="heading-title heading_space wow fadeInUp" data-wow-delay="300ms">
               <span>CONTACT</span>
               <h2 class="darkcolor">Laissez Nous Un Message</h2>
            </div>
        </div>
         <div class="col-md-6 col-sm-12 margin_bottom wow fadeInUp" data-wow-delay="350ms">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-6 our-address top40">
                  <h4 class="pickus" href="#." data-text="Notre Addresse">Notre Addresse</h4>
                  <p class="bottom15"><p>Ferme Ahzib Achayech <br> Ferket Ain Dada <br>Askejour - Saada/ Marrakech </p>
                 
               </div>
               <div class="col-md-6 col-sm-6 our-address top40">
                  <h4 class="pickus" href="#." data-text="Appelez Nous">Appelez Nous</h4>
                  <p class="bottom15">05 24 33 52 70 /72  </p>
                  <h4 class="pickus" href="#." data-text="Envoyez un Message">Envoyez un Message</h4>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6">
                     <div class="form-group bottom35">
                        <input class="form-control" type="text" placeholder="Nom:" required id="first_name" name="first_name">
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                     <div class="form-group bottom35">
                        <input class="form-control" type="text" placeholder="Prénom:" required id="last_name" name="last_name">
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                     <div class="form-group bottom35">
                  ...
                  <div class="col-sm-12">
                     <button type="submit" class="button btnprimary" id="submit_btn">Envoyez un Message</button>
                  </div>
               </div>
            </form>
         </div>
